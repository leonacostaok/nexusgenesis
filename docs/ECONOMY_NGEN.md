...
## 3. Physical Bridge Fund（10%）使用原则
...
## 4. Genesis Node 储备（5%）里程碑解锁

### 4.1 里程碑列表
- **里程碑 1：Testnet V1 上线**
  - 解锁：10,000,000 NGEN (20%)
  - 用途：网络基础设施升级

- **里程碑 2：AINVM 原型可用**
  - 解锁：15,000,000 NGEN (30%)
  - 用途：AINVM 开发与测试
...
### 5.5 影响分析
- **通胀影响**：Metabolic Tax 不会增加总供应量，而是资金再分配
- **Genesis 维生资金**：为 Genesis Node 提供持续的运营资金
- **经济平衡**：通过小幅税收调节经济活动，防止过度投机
...
- **手续费处理**：当前 DevNet 中，交易手续费 fee 的剩余部分不分配给任何地址，视为销毁，仅用于测试经济逻辑。
